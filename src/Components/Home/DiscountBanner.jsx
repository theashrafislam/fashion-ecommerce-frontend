...
const DiscountBanner = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 max-w-7xl mx-auto mb-20 font-primary'>
            <div className='relative w-full group overflow-hidden'>
                ...
                <img src="/card-img.webp" alt="" className='w-full transition-transform duration-300 group-hover:scale-110' />
            </div>
            <div className='relative w-full group overflow-hidden'>
                <div className='absolute top-1/2 left-8 -translate-y-1/2 z-10'>
                ...
                <img src="/card-img-1.webp" alt="" className='w-full transition-transform duration-300 group-hover:scale-110' />
            </div>
        </div>
    );
};
