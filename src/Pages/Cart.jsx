    ...
    return (
        <div className='font-primary'>
            ...
            <div className='max-w-7xl mx-auto my-14 flex flex-col gap-8 items-end'>
                    ...
                    <div className="border border-gray-300 p-4 rounded-lg">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                            ...
                            <div className="flex w-full md:w-auto items-center gap-2">
                                <input
                                    type="text"
                                    className="p-3 border border-gray-300 rounded-md text-base w-full md:w-64"
                                    placeholder="Enter Your Coupon Code"
                                />
                                <button className="px-6 py-3 bg-black text-white font-semibold rounded-md hover:bg-red-500 transition duration-300">
                                    Apply Coupon
                                </button>
                            </div>
                ...
                <div className="bg-white border border-gray-200 p-6 rounded-md shadow-md w-[35%]">
                    {/* Title */}
